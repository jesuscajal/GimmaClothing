    ...
    return (
      <div className="flex flex-col items-center rounded-xl bg-white py-20 text-center">
        ...
        <p className="mt-2 text-sm text-neutral-500">
          Explorá la tienda y encontrá tu próxima prenda
        </p>
        <Link
          href={gimmaPath(basePath, "tienda")}
          className="mt-8 rounded-lg bg-beige-800 px-8 py-3 text-sm font-medium text-white transition hover:bg-beige-900"
        >
          Ir a la tienda
        </Link>
      </div>
    ...
    <div className="grid gap-8 lg:grid-cols-3">
      <div className="rounded-xl bg-white p-6 lg:col-span-2">
        <ul className="divide-y divide-beige-200">
          {items.map((item) => {
            ...
            return (
              ...
              >
                <div className="h-28 w-24 shrink-0 overflow-hidden rounded-xl bg-beige-100">
                  {image && (
                ...
                <div className="flex flex-1 flex-col justify-between">
                  <div>
                    <Link
                      ...
                      className="font-serif text-lg text-black hover:text-beige-700"
                    >
                      {item.title}
                    </Link>
                  ...
                  <div className="mt-4 flex items-center gap-4">
                    <div className="flex items-center rounded-lg border border-beige-200 bg-beige-50">
                      <button
                        type="button"
                        onClick={() =>
                          updateQuantity(
                        ...
                        className="px-3 py-1.5 text-neutral-500 hover:text-black"
                      >
                        −
                      </button>
        ...
        <button
          type="button"
          onClick={clearCart}
          className="mt-4 text-sm text-neutral-500 underline hover:text-black"
        >
          Vaciar carrito
        </button>
      </div>
      ...
      <div className="h-fit rounded-xl bg-white p-6">
        <h2 className="text-xs font-medium tracking-[0.15em] text-neutral-500 uppercase">
          Resumen
        </h2>
        <div className="mt-6 space-y-2 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <span className="text-neutral-500">A coordinar</span>
          </div>
        </div>
        <div className="mt-4 flex justify-between border-t border-beige-200 pt-4">
          ...
          <>
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white px-3 text-neutral-500">o</span>
              </div>
            </div>
            <GimmaCheckoutButton items={items} countryCode={countryCode} />
          </>
        )}

        <Link
          href={gimmaPath(basePath, "tienda")}
          className="mt-4 block text-center text-sm text-neutral-500 underline hover:text-black"
        >
          Seguir comprando
        </Link>
      </div>
